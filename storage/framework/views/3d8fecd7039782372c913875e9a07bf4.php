<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="bg-blue-500 text-white rounded-lg shadow-lg p-5 flex items-center">
        ...
        <div>
            ...
            <p class="text-4xl mt-1 font-bold"><?php echo e($totalInvoices); ?></p>
        </div>
    </div>
    ...
    <div class="bg-green-500 text-white rounded-lg shadow-lg p-5 flex items-center">
        ...
        <div>
            ...
            <p class="text-4xl mt-1 font-bold"><?php echo e($totalProducts); ?></p>
        </div>
    </div>
    ...
    <div class="bg-yellow-500 text-white rounded-lg shadow-lg p-5 flex items-center">
        ...
        <div>
            ...
            <p class="text-4xl mt-1 font-bold"><?php echo e($totalClients); ?></p>
        </div>
    </div>
    ...
    <div class="bg-purple-500 text-white rounded-lg shadow-lg p-5 flex items-center">
        ...
        <div>
            ...
            <p class="text-4xl mt-1 font-bold"><?php echo e($totalSales); ?></p>
        </div>
    </div>
</div>
<?php /**PATH /home/ryan/Projects/nota-fiscal-facil/resources/views/components/dashboard.blade.php ENDPATH**/ ?>